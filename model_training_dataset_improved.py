# Improved training script for datacore.csv
# - Treats zeros in N/P/K as missing and imputes median
# - Adds simple feature engineering (N/P, N/K, P/K ratios)
# - Trains a RandomForest baseline with class_weight='balanced'
# - Saves model and analysis to model_dataset_improved/
...
OUT_DIR = "model_dataset_improved"
...
# Treat zeros in N/P/K as NaN (likely missing sensor readings)
...
# Feature engineering: ratios (avoid division by zero)
...
# Fill any inf/nan from ratios
X_imp = X_imp.replace([np.inf, -np.inf], np.nan)
# Re-fit an imputer on the extended feature set (ratios added)
...
# RandomForest baseline with balanced class weights
...
# Optional: quick feature importance plot
